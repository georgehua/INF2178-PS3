...
##Feature Selection:
#From the results below, we can see that variables such as "Age First Code" and "Developer Type" might not be the most influential elements.
```{r}
...
model_1 <- lm(Compensation_in_USD ~ Years_Coding_Professionally+Education_Level+OpenSourcer+Gender+Work_Hours_Per_Week+language_count, data = sod_survey_selected)
summary(model_1)
...
There is a few shortcomings in the dataset:
