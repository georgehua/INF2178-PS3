...
# This step only removes management job types as independent variables but does not guarantee the eliminateion of outliers.
...
# Pre-processing:
# Create new columns containing the numbers of programming languages, database, and webframe used by respondents on a daily basis
...
plot(model_1, 1) # Testing linearity and constant variance
plot(model_1, 2) # Testing normality
plot(model_1, 5) # Check for outliers
